...
OSM_HOME=`pwd`
DB_HOME=/home/maxl/Maps/osm/db
/usr/java/jdk-13.0.2/bin/java -Dosm.db.path=$DB_HOME --module-path $JAVA_FX_HOME/lib --add-modules javafx.controls,javafx.fxml --add-modules javafx.base,javafx.graphics \
